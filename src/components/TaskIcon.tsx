...
export function TaskIcon({ id }: { id: TaskId }) {
  ...
  return <svg viewBox="0 0 160 130" role="img" aria-hidden="true">
    ...
    {id === 'bag' && <g {...common}><path d="M45 55c0-20 13-32 35-32s35 12 35 32v58H45Z"/><path d="M58 55V43c0-11 8-18 22-18s22 7 22 18v12M45 69h70M61 69v44M99 69v44"/><path d="M64 83h32v20H64z"/></g>}
